var Page = function(){
	var companyKpiChart;
	var initEchartMap = function(){
		 // 基于准备好的dom，初始化echarts图表
        var companyKpiChart = echarts.init(document.getElementById('main')); 
	...
	function initKpiTrend(){
		var myChart = echarts.init(document.getElementById('kpiTrend'));
		option = {
		    title : {
		        text: '环评指数走势'
		    },
		    ...
		    series : [
		        {
		            name:'环评指数',
		            type:'line',
		            data:[342, 487, 431, 465, 567, 654, 718],
		            markPoint : {
		                data : [
		                    {type : 'max', name: '最大值'},
		                    {type : 'min', name: '最小值'}
