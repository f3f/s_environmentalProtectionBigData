...
var punish = function () {
    ...
    var moneyAnalyse = function(){
        var option = {
            ...
            legend: {
                data: ['空气污染','水体污染','噪声污染','危险废物污染','固体废物污染']
            },
            grid: {
                left: '3%',
                right: '4%',
    ...
    return {
        init: function () {
            var typeAnalyse = PieConnect.init('punish.typeAnalyse','punish.typeAnalyseMinor',analyseData());
            var moneyAnalyse = initEchart('punish.moneyAnalyse');
            var index = initEchart('punish.index');
            var map = initEchart('punish.map');
        },

        moneyAnalyse: function(){
            return moneyAnalyse();
        },
